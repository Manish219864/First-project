        ...
        <div id="orders-section">
          <div className="tabs">
            ...
            <button
              ...
              onClick={() => showTab('manage-courier')}
            >
              Manage Courier
            </button>
            <button
          ...
          <div id="tab-content">
            <div id="wallet" className={`tab ${activeTab === 'wallet' ? 'active' : ''}`}>
              <p>No wallet data available.</p>
            </div>
            <div id="cod-remittance" className={`tab ${activeTab === 'cod-remittance' ? 'active' : ''}`}>
              <p>No COD remittance data available.</p>
            </div>
            <div id="rate-card" className={`tab ${activeTab === 'rate-card' ? 'active' : ''}`}>
              <p>No rate card data available.</p>
            </div>
            <div id="billing" className={`tab ${activeTab === 'billing' ? 'active' : ''}`}>
              <p>No billing data available.</p>
            </div>
            <div id="manage-courier" className={`tab ${activeTab === 'manage-courier' ? 'active' : ''}`}>
              <p>No courier management data available.</p>
            </div>
            <div id="kyc" className={`tab ${activeTab === 'kyc' ? 'active' : ''}`}>
